...
<div class="centerColumn" id="checkoutConfirmDefault">
    ...
    <div id="checkoutBillto" class="back">
        ...
        <?php if (!$flagDisablePaymentAddressChange) { ?>
            <div
                class="buttonRow forward"><?php echo '<a href="' . zen_href_link(FILENAME_CHECKOUT_PAYMENT, '', 'SSL') . '">' . zen_image_button(BUTTON_IMAGE_EDIT_SMALL, BUTTON_EDIT_SMALL_ALT) . '</a>'; ?></div>
        <?php } ?>
    ...
    if ($_SESSION['sendto'] != false) {
        ...
        <div id="checkoutShipto" class="forward">
            ...
            <div
                class="buttonRow forward"><?php echo '<a href="' . $editShippingButtonLink . '">' . zen_image_button(BUTTON_IMAGE_EDIT_SMALL, BUTTON_EDIT_SMALL_ALT) . '</a>'; ?></div>
    ...
    <div
        class="buttonRow forward"><?php echo '<a href="' . zen_href_link(FILENAME_SHOPPING_CART, '', 'SSL') . '">' . zen_image_button(BUTTON_IMAGE_EDIT_SMALL, BUTTON_EDIT_SMALL_ALT) . '</a>'; ?></div>
    <br class="clearBoth"/>
    ...
    ?>
    <div id="btn_submit" class="buttonRow forward">
